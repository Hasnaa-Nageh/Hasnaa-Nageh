...
On the **frontend**, I work with React, TypeScript, HTML, and CSS to create responsive interfaces and intuitive user experiences. On the **backend**, I develop scalable APIs using Node.js and Express.js, and manage data with MongoDB.
